...
const projects: Project[] = [
  {
    ...
    year: '2024',
    title: 'Project Alpha',
    body: 'A full-stack SaaS dashboard for managing [X]. Built with Next.js, Postgres, and Stripe. Shipped in 8 weeks from first commit to production.',
  ...
  },
  {
    ...
    year: '2023',
    title: 'Project Gamma',
    body: 'Inherited a five-year-old React codebase with no tests and three critical security vulnerabilities. Stabilised, migrated to TypeScript, and handed back to the client\'s team.',
...
function renderCard(p: Project, index: number): string {
  return `
    <div class="work-card reveal reveal-delay-${index + 1}">
